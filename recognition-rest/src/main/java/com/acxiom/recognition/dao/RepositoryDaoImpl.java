...
public class RepositoryDaoImpl implements RepositoryDao {
    ...
    @PersistenceContext(unitName = "recognitionPersistence")
...
//    }
    ...
    public RepositoryEntity getRepositoryById(Long id) {
        ...
        try {
            String qlString = "SELECT r FROM RepositoryEntity r WHERE r.id = ?1";
            TypedQuery<RepositoryEntity> query = entityManager.createQuery(qlString, RepositoryEntity.class);
